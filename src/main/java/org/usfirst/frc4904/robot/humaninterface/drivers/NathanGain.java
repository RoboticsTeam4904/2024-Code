...
public class NathanGain extends Driver {
    ...
    // TODO: tune
    public static final double NORMAL_SPEED_GAIN = 0.5;
    ...
    public void bindCommands() {
        ...
        RobotMap.HumanInput.Driver.xbox.y().onTrue(
            new InstantCommand(() -> NathanGain.precisionScaleY = 1)
        );

        RobotMap.HumanInput.Driver.xbox.y().onFalse(
            new InstantCommand(() -> NathanGain.precisionScaleY = NORMAL_SPEED_GAIN)
        );
    }
